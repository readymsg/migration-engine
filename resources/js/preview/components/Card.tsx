...
// (see Text.tsx docblock). Card bodies are usually short prose ("Read
// More" tags, one-paragraph blurbs) but some sources render bold/italic
// or short links inside them. Without markdown parsing, `**foo**`
// shows literally in the preview.
//
